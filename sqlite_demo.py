# -*- coding: utf-8 -*-
"""
Created on Tue Aug 20 00:21:23 2019
...
emp1 = Employee('BalRam', 'Kumar', 38000)
emp2 = Employee('Vijay', 'Kumar', 30000)
emp3 = Employee('Scott', 'Larry', 23000)
...
c.execute("INSERT INTO employee VALUES(?, ?, ?)", (emp1.first, emp1.fullname, emp1.pay))
